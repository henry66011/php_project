        ...
        <div class="row">
            ...
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  ...
                  <li>
                    <img src="image/product-01-2.jpeg" />
                  </li>
          ...
          <div class="col-md-6">
            <div class="right-content">
              <?php
                $name='畢伯格－檸檬啤酒(Bitburger Radler)';
                $cost='100';
                $brand='品牌：Bitburger畢伯格';
                $type='類型：Radler蘇打啤酒';
                $capacity='容量：330ml';
                $AVB='AVB：2.5%';
              ?>
              ...
              <div class="down-content">
                ...
                <div class="categories">
                  <h6>
                    <ul>
                      <li id="product">檸檬香搭配麥芽啤酒味</li>
                      <li id="product">適合搭配宵夜、烤肉或運動過後飲用</li>
                      <li id="product">低酒精濃度，無負擔</li>
                    </ul>
                  </h6>
                </div>
                <div class="product_meta">
                  分類：
                  <a href="https://beer-bee.com/product-category/hot-sale/" rel="tag">水果啤酒</a>,  
                  <a href="https://beer-bee.com/product-category/special-beer/" rel="tag">淡色啤酒</a>,  
