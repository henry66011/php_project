...
<html lang="en">
  ...
  <head>
    ...
    <title>女皇爵勃根第棕啤酒(Verhaeghe Duchesse De Bourgogne)</title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="image/product-04.jpg" />
                  </li>
                  <li>
                    <img src="image/product-04-2.jpeg" />
                  </li>
          ...
          <div class="col-md-6">
            <div class="right-content">
              <?php
                $name='女皇爵勃根第棕啤酒(Verhaeghe Duchesse De Bourgogne)';
                $cost='130';
                $brand='品牌：Verhaeghe佛赫森';
                $type='類型：Sour Red/Brown法蘭德斯酸愛爾';
                $capacity='容量：330ml';
                $AVB='AVB：6.2%';
              ?>
              <br>
              ...
              <div class="down-content">
                ...
                <div class="categories">
                  <h6>
                    <ul>
                      <li id="product">使用烘烤麥芽和陳年啤酒花經過頂部發酵與自主發酵的混釀橡木桶啤酒</li>
                      <li id="product">帶有紅酒香氣</li>
                      <li id="product">濃郁的果香和明顯的梅子酸味</li>
                    </ul>
                  </h6>
                </div>
                <div class="product_meta">
                  分類：
                  <a href="https://beer-bee.com/product-category/hot-sale/" rel="tag">酸啤酒</a>,  
